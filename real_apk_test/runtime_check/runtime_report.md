...
## Trạng thái: THIẾU MÔI TRƯỜNG (hợp lệ)

Không có device/emulator kết nối (adb devices trống) — M2/M3 chưa nghiệm thu được. Kết nối thiết bị hoặc khởi động emulator rồi chạy lại.
